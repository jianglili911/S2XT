...
/**
 * Created by jianglili on 2017/3/22.
 */
public class DBpediaTest
{
    //DBpedia 10 50 100 200 数据集大小
    // 10 :  15,373,833


    public static void main(String[] args) throws Exception {
        args=new String("-i E:/benchmarks/dbpedia/benchmark.dbpedia/head_500000 " +
                "-mem 3g -q E:/benchmarks/dbpedia/query2011/1-TriplePatterns.rq " +
                "-s E://benchmarks//dbpedia//dbpedia_2015-10.owl "+
                "-t E:\\benchmarks\\dbpedia\\count\\count__.txt " +
                "-so -l -jn sqX ").split(" ");
