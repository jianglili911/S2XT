 ...
 */
public class lubmWithoutSchemaTest {
    public static void main(String[] args) throws Exception{
   //-countBased
        args=new String("-i E:/benchmarks/LUBM/datasets/nt1 " +
                "-mem 2g -q E:/benchmarks/LUBM/query28/query1.rq," +
                "E:/benchmarks/LUBM/query28/query1.rq " +
//                "-o E:/benchmarks/LUBM/result/result.nt " +
                "-s E://benchmarks//LUBM//univ-benchQL.owl "+
                "-t E:\\benchmarks\\LUBM\\count\\count__w.txt " +
                "-so -l -jn sparkX ").split(" ");

        ArgumentParser.parseInput(args);
        Logger log = Logger.getLogger(lubmWithoutSchemaTest.class);
