...
object TriplePatternProcessor {
  ...
  /**
    ...
    * @return
    */
  def matchBGP(tripleC: Accumulator[Int],
               triples: Broadcast[java.util.List[TriplePattern]],
  ...
  /**
    ...
    *
    */
  def joinResultsIntoGraph(msgs: RDD[(VertexId, IMessage)], graph: Graph[VertexInterface, EdgeAttribute])
  : Graph[VertexInterface, EdgeAttribute] = {
  ...
  /**
    ...
    *
    */
  def joinNeighborsIntoGraph(msgs: RDD[(VertexId, IMessage)], graph: Graph[VertexInterface, EdgeAttribute])
  : Graph[VertexInterface, EdgeAttribute] = {
