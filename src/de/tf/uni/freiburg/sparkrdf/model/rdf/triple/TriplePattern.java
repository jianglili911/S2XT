...
public class TriplePattern implements Serializable {
     ...
     * @return true iff subject, predicate and object fulfill this triple
     */
    public Boolean isFulfilledByTriplet2(VertexAttribute subject,
                                        String predicate, VertexAttribute object) {
      return
              checkQueryPart(predicate, this.predicate)&&
                      checkQueryPart(subject.getAttribute(), this.subject)&&

        checkQueryPart(object.getAttribute(), this.object);
