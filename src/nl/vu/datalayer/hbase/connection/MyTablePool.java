...
/**
 * Created by jianglili on 2016/9/14.
 */
public class MyTablePool implements Closeable {
         ...
         */
        public MyTablePool(final Configuration config, final int maxSize) {
         ...
         *          maximum number of references to keep for each table
         * @param poolType
         *          pool type which is one of {@link PoolMap.PoolType#Reusable} or
    ...
    public HTableInterface getTable(String tableName) {
        ...
        return new MyTablePool.PooledHTable(table);
    }
    ...
    public void putTable(HTableInterface table) throws IOException {
        ...
        // proxy
        // table
        if (table instanceof MyTablePool.PooledHTable) {
            returnTable(((MyTablePool.PooledHTable) table).getWrappedTable());
        } else {
