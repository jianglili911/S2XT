...
public class HBaseLoader {
	...
	private Table id2StringTable;
	
	private HBaseConnection con;
	private String schemaSuffix;
	private Table string2IdTable;
	...
	private void loadIndexTables()
			throws IOException {
		Table spocTable = con.getTable(HBPrefixMatchSchema.TABLE_NAMES[HBPrefixMatchSchema.SPOC]+schemaSuffix);
		Table pocsTable = con.getTable(HBPrefixMatchSchema.TABLE_NAMES[HBPrefixMatchSchema.POCS]+schemaSuffix);
		Table ospcTable = con.getTable(HBPrefixMatchSchema.TABLE_NAMES[HBPrefixMatchSchema.OSPC]+schemaSuffix);
