...
public class ReorderHeuristics implements ReorderTransformation {
	...
	public ReorderProc reorderIndexes(BasicPattern pattern) {
        ...
        List<PatternTriple> components = Iter.map(triples, convert) ;
 ...
 // Triples to TriplePatterns.
    private static Transform<Triple, PatternTriple> convert =
         new Transform<Triple, PatternTriple>(){
        @Override
        public PatternTriple apply(Triple triple)
        {
