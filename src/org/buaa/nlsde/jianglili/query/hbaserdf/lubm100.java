...
public class lubm100 {
    ...
    public static void main(String[] args) throws OWLOntologyCreationException, OWLOntologyStorageException, FileNotFoundException {
        Const.timeFilePath_$eq("E:\\benchmarks\\LUBM\\count\\hbaserdf\\lubm100.txt");
        Quorum.confFile="config"+"100"+".properties";
    ...
    public static void query(String  querydir) throws OWLOntologyCreationException, OWLOntologyStorageException, FileNotFoundException {
        ...
        for(int i=19;i<nums.length;i++) {
            runSPARQLQuery(querydir + "\\query" + nums[i] + ".rq", model,concept,1);
            runSPARQLQuery(querydir + "\\query" + nums[i] + ".rq", model,concept,2);
        }

    }

    public static void runSPARQLQuery(String queryfile, Model model, Concept concept,int qc) throws OWLOntologyCreationException, OWLOntologyStorageException, FileNotFoundException {
